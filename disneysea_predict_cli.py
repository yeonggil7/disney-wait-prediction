...
HEATMAP_TARGET_ATTRACTIONS_SEA = [
    'ソアリン', 'アナとエルサ', 'センターオブジアース', 'タワーオブテラー',
    'トイストーリーマニア', 'ラプンツェル', 'ピーターパン',
    'プラザグリーティング', 'レイジングスピリッツ', 'インディージョーンズクリスタルスカルの謎',
]
...
def generate_heatmap(predictions, date, output_dir="predictions"):
    ...
    target_mask = predictions_filtered['attraction_name'].apply(
        lambda name: any(t in name for t in HEATMAP_TARGET_ATTRACTIONS_SEA)
    )
