...
class DisneySeaFeatureEngineerV3:
    ...
    def __init__(self):
        ...
        self.attraction_popularity = {
            'ソアリン': 10, 'アナとエルサ': 10, 'ラプンツェル': 9, 'ピーターパン': 9,
            'トイストーリーマニア': 9, 'センターオブジアース': 8, 'タワーオブテラー': 8,
            'インディージョーンズクリスタルスカルの謎': 7, 'レイジングスピリッツ': 7,
            'ティンカーベル': 7, 'タートル・トーク': 6, '海底二万マイル': 6,
            'ニモandフレンズシーライダー': 6, 'マジックランプシアター': 5, 'シンドバッド': 5,
            'アクアトピア': 5, 'ゴンドラ': 4, 'ジャスミン': 4, 'カルーセル': 3,
            'ジャンピン': 3, 'スカットルのスクーター': 3, 'フランダー': 3,
            'バルーンレース': 3, 'ワールプール': 3, 'マーメイドラグーン': 3,
            '船メディテレーニアンハーバー発': 2, '船アメリカンウォーターフロント発': 2,
            '船ロストリバーデルタ発': 2, 'エレクトリックレールウェイアメリカンウォーターフロント発': 2,
            '鉄道ポートディスカバリー発': 2, 'ヴィークル': 2, 'フォートレスエクスプロレーション': 2,
            'プラザグリーティング': 5, 'ヴィレッジグリーティング': 4, 'サルードス・アミーゴス': 4,
            'ドナルドグリーティング': 5, 'ミッキーグリーティング': 6, 'ミニーグリーティング': 6,
            'マーメイドラグーングリーティング': 4, 'アラビアンコーストグリーティング': 4
        }
        
        # 屋外/屋内アトラクション
        self.outdoor_attractions = {
            'ソアリン': False, '船メディテレーニアンハーバー発': True,
            'フォートレスエクスプロレーション': True, 'ゴンドラ': True,
            'タワーオブテラー': False, 'トイストーリーマニア': False,
            'タートル・トーク': False, 'エレクトリックレールウェイアメリカンウォーターフロント発': True,
            '船アメリカンウォーターフロント発': True, 'ヴィークル': True,
            'センターオブジアース': False, '海底二万マイル': False,
            'ニモandフレンズシーライダー': False, 'アクアトピア': True,
            '鉄道ポートディスカバリー発': True, 'インディージョーンズクリスタルスカルの謎': False,
            'レイジングスピリッツ': True, '船ロストリバーデルタ発': True,
            'マーメイドラグーン': False, 'ジャンピン': False, 'スカットルのスクーター': False,
            'フランダー': False, 'バルーンレース': False, 'ワールプール': False,
            'アナとエルサ': False, 'ラプンツェル': False, 'ピーターパン': False,
            'ティンカーベル': False, 'マジックランプシアター': False, 'カルーセル': True,
            'シンドバッド': False, 'ジャスミン': True, 'プラザグリーティング': True,
            'ヴィレッジグリーティング': True, 'サルードス・アミーゴス': False,
            'ドナルドグリーティング': False, 'ミッキーグリーティング': False,
            'ミニーグリーティング': False, 'マーメイドラグーングリーティング': False,
    ...
    def add_interaction_features(self, df):
        ...
        df['fantasy_springs_holiday'] = df['is_fantasy_springs'] * df['is_long_weekend']
...
class DisneySeaWaitTimePredictorV3:
    """ディズニーシー待ち時間予測モデル（時系列対応・曜日強化版）"""
    ...
    def __init__(self, decay_rate=0.15, seasonal_boost=2.0):
        ...
        """
        self.feature_engineer = DisneySeaFeatureEngineerV3()
        self.models = {}
        self.feature_columns = None
        self.scaler = StandardScaler()
        self.model_dir = "models_v3"
    ...
    def prepare_features(self, df, fit=True, with_weather=True):
        ...
        feature_cols = [
            ...
            'event_popularity', 'fantasy_springs_weekend', 'fantasy_springs_holiday',
    ...
    def apply_weekly_adjustment(self, df, target_date):
        ...
        prev_week_file = os.path.join(data_dir, f"disneysea_daily_{prev_week_date.strftime('%Y-%m-%d')}.csv")
        prev_prev_week_file = os.path.join(data_dir, f"disneysea_daily_{prev_prev_week_date.strftime('%Y-%m-%d')}.csv")
...
def main():
    """メイン処理"""
    print("🏰 ディズニーシー待ち時間予測システム V3")
    print("   （時系列対応・直近重視・曜日強化版）")
    print("=" * 60)
    
    # 時間減衰率を設定（0.15 = 約5日で重みが半減、直近重視）
    # 季節ブースト（同月データに2倍の重み）
    predictor = DisneySeaWaitTimePredictorV3(decay_rate=0.15, seasonal_boost=2.0)
